...
---@class hyprpilot.Logger: hyprpilot.LogAtLevel
---@field setup hyprpilot.LoggerSetupFn
---@field config hyprpilot.LoggerConfig
---@field p hyprpilot.LogAtLevel

---@class hyprpilot.LogAtLevel
...
---@class hyprpilot.Logger
local M = {
  ---@diagnostic disable-next-line: missing-fields
  p = {},
}

---@class hyprpilot.LoggerConfig
---@field level number
---@field plugin string
---@field modes hyprpilot.LoggerMode[]

---@class hyprpilot.LoggerMode
---@field name string
---@field level number

---@type hyprpilot.LoggerConfig
M.config = {
  level = vim.log.levels.INFO,
  plugin = "hyprpilot.nvim",
  modes = {
...
---@class hyprpilot.LoggerSetup
---@field level? number

---@alias hyprpilot.LoggerSetupFn fun(config?: hyprpilot.LoggerSetup): hyprpilot.Logger

---@type hyprpilot.LoggerSetupFn
