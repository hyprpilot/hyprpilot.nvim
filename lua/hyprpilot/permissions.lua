...
---Send `optionId` for `requestId` to the daemon. The optional
---callback receives `(err, result)` per the standard client shape.
---@param request_id string
---@param option_id string
---@param callback? fun(err: hyprpilot.client.RpcError?, result: any?)
function M.respond(request_id, option_id, callback)
  ...
  client.request("permissions/respond", { requestId = request_id, optionId = option_id }, nil, function(err, result)
